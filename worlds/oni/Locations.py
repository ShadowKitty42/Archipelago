...
resource_locations: typing.Dict[str, typing.Dict[str, typing.List[str]]] = {
    "terra_base": {
		...
		"advanced": [
		    "Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Sleet Wheat Grain", "Wort Seed", "Waterweed Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Fungal Spore",
            "Buddy Bud Seed", "Thimble Reed Seed", "Obsidian", "Abyssalite", "Fossil", "Granite", "Lead", "Iron Ore", "Diamond",  "Ice", "Polluted Ice", "Sedimentary Rock", "Salt",
            "Bleach Stone", "Slime", "Gold Amalgam", "Wolframite", "Clay", "Phosphorite", "Regolith", "Mafic Rock", 
		]
	},
    "ceres_base": {
		"basic": [
		...
		"advanced": [
			 "Polluted Water", "Granite", "Sporechid Seed", "Joya Seed", "Arbor Acorn", "Mirth Leaf Seed", "Hexalent Fruit", "Mealwood Seed", "Oxyfern Seed", "Pincha Pepper Seed", "Nosh Bean",
             "Dasha Saltvine Seed", "Plume Squash Seed", "Carved Lumen Quartz", "Waterweed Seed", "Sleet Wheat Grain", "Wort Seed", "Bonbon Tree Seed", "Obsidian", "Abyssalite", "Sand",
             "Fossil", "Lead", "Iron Ore", "Diamond", "Coal", "Aluminum Ore", "Wolframite", "Salt", "Mafic Rock", "Rust", "Bleach Stone", "Sedimentary Rock", "Sucrose", "Fertilizer",
             "Sandstone", "Algae", "Slime", "Mercury", 
		]
	},
    "oceania_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Pincha Pepper Seed", "Waterweed Seed", "Wort Seed", "Sleet Wheat Grain", "Fungal Spore",
            "Buddy Bud Seed", "Thimble Reed Seed", "Abyssalite", "Granite", "Lead", "Fossil", "Obsidian", "Iron Ore", "Diamond", "Sedimentary Rock", "Phosphorite", "Salt", "Bleach Stone",
            "Ice", "Wolframite", "Polluted Ice", "Slime", "Clay", "Gold Amalgam", "Regolith", "Mafic Rock", 
		]
	},
    "rime_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Iron Ore", "Slime", "Sporechid Seed", "Pincha Pepper Seed", "Waterweed Seed", "Hexalent Fruit", "Arbor Acorn", "Fungal Spore", "Thimble Reed Seed", "Wort Seed",
            "Obsidian", "Abyssalite", "Fossil", "Granite", "Lead", "Diamond", "Iron", "Sedimentary Rock", "Polluted Ice", "Bleach Stone", "Clay", "Gold Amalgam", "Salt", "Mafic Rock", "Rust",
            "Wolframite", "Aluminum Ore", "Regolith", "Joya Seed", "Mirth Leaf Seed", "Buddy Bud Seed", "Nosh Bean", "Oxyfern Seed", "Sleet Wheat Grain", 
		]
	},
    "verdante_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Granite", "Balm Lily Seed", "Pincha Pepper Seed", "Waterweed Seed", "Joya Seed", "Sporechid Seed", "Nosh Bean", "Dasha Saltvine Seed", "Fungal Spore",
            "Buddy Bud Seed", "Thimble Reed Seed", "Abyssalite", "Iron Ore", "Sandstone", "Sand", "Bleach Stone", "Fossil", "Lead", "Coal", "Algae", "Slime", "Clay", "Gold Amalgam", "Diamond", "Salt",
            "Rust", "Mafic Rock", "Ice", "Wolframite", "Fertilizer", "Regolith", "Obsidian",
		]
	},
    "arboria_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Granite", "Sporechid Seed", "Waterweed Seed", "Joya Seed", "Balm Lily Seed", "Pincha Pepper Seed", "Dasha Saltvine Seed", "Nosh Bean", "Sleet Wheat Grain", "Wort Seed",
            "Obsidian", "Abyssalite", "Lead", "Coal", "Sand", "Bleach Stone", "Iron Ore", "Rust", "Sedimentary Rock", "Mafic Rock", "Iron", "Salt", "Sandstone", "Polluted Ice", "Ice", "Wolframite",
            "Algae", "Diamond", "Slime", "Fertilizer", "Regolith", "Copper Ore", "Fossil", 
		]
	},
    "volcanea_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Sleet Wheat Grain", "Wort Seed", "Waterweed Seed", "Thimble Reed Seed", "Fungal Spore", "Buddy Bud Seed",
            "Balm Lily Seed", "Mirth Leaf Seed", "Abyssalite", "Lead", "Fossil", "Granite", "Iron Ore", "Diamond", "Polluted Ice", "Sedimentary Rock", "Wolframite", "Bleach Stone", "Slime",
            "Ice", "Gold Amalgam", "Salt", "Clay", "Phosphorite", "Regolith", "Mafic Rock", "Obsidian", 
		]
	},
    "badlands_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Granite", "Iron Ore", "Mafic Rock", "Rust", "Dasha Saltvine Seed", "Nosh Bean", "Joya Seed", "Pincha Pepper Seed", "Sporechid Seed", "Balm Lily Seed", "Mirth Leaf Seed",
            "Wort Seed", "Waterweed Seed", "Abyssalite", "Fossil", "Lead", "Iron", "Diamond", "Salt", "Bleach Stone", "Phosphorite", "Ice", "Polluted Ice", "Wolframite", "Slime", "Sedimentary Rock",
            "Regolith", "Sleet Wheat Grain", 
		]
	},
    "aridio_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Dasha Saltvine Seed", "Waterweed Seed", "Fungal Spore", "Buddy Bud Seed", "Thimble Reed Seed",
            "Obsidian", "Abyssalite", "Lead", "Granite", "Diamond", "Ice", "Iron Ore", "Polluted Ice", "Wolframite", "Coal", "Sand", "Iron", "Salt", "Sedimentary Rock", "Bleach Stone", "Sandstone",
            "Sulfur", "Rust", "Mafic Rock", "Algae", "Slime", "Clay", "Gold Amalgam", "Fossil", "Fertilizer", "Regolith", "Wort Seed", "Nosh Bean", 
		]
	},
    "oasisse_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Waterweed Seed", "Pincha Pepper Seed", "Fungal Spore", "Buddy Bud Seed", "Thimble Reed Seed", "Muckroot", "Blossom Seed", "Balm Lily Seed",
            "Briar Seed", "Obsidian", "Abyssalite", "Fossil", "Lead", "Granite", "Sedimentary Rock", "Bleach Stone", "Diamond", "Salt", "Iron Ore", "Algae", "Slime", "Gold Amalgam", "Clay", "Coal",
            "Sandstone", "Copper Ore", "Fertilizer", "Ice", "Wolframite", "Iron", "Mafic Rock", "Regolith", 
		]
	},
    "skewed_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Sleet Wheat Grain", "Waterweed Seed", "Wort Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Sporechid Seed", "Fungal Spore", "Thimble Reed Seed",
            "Buddy Bud Seed", "Joya Seed", "Abyssalite", "Fossil", "Lead", "Ice", "Polluted Ice", "Granite", "Salt", "Sedimentary Rock", "Bleach Stone", "Slime", "Gold Amalgam", "Wolframite",
            "Phosphorite", "Iron Ore", "Mafic Rock", "Regolith", "Clay", "Diamond", "Iron", "Obsidian", 
		]
	},
    "blasted_base": {
		"basic": [
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Mealwood Seed", "Oxyfern Seed", "Arbor Acorn", "Mirth Leaf Seed", "Hexalent Fruit", "Pincha Pepper Seed", "Carved Lumen Quartz",
            "Plume Squash Seed", "Sleet Wheat Grain", "Wort Seed", "Waterweed Seed", "Bonbon Tree Seed", "Obsidian", "Granite", "Igneous Rock", "Coal", "Abyssalite", "Lead", "Iron Ore", "Fossil",
            "Diamond", "Aluminum Ore", "Iron", "Sand", "Sedimentary Rock", "Rust", "Mafic Rock", "Bleach Stone", "Polluted Ice", "Wolframite", "Sucrose", "Salt", "Sandstone", "Slime", "Algae",
            "Fertilizer", "Mercury", "Copper Ore", "Nosh Bean", 
		]
	},
    "terra": {
        "basic": [
    ...
    "oceania": {
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Fungal Spore", "Sleet Wheat Grain", "Wort Seed", "Mallow Seed", "Bog Bucket Seed",
            "Swamp Chard Heart", "Thimble Reed Seed", "Obsidian", "Abyssalite", "Igneous Rock", "Fossil", "Lead", "Granite", "Diamond", "Iron Ore", "Polluted Ice", "Ice", "Wolframite", "Cobalt Ore",
            "Slime", "Sedimentary Rock", "Clay", "Gold Amalgam", "Polluted Dirt", "Uranium Ore", "Mud", "Polluted Mud", "Phosphorite", "Bleach Stone", "Salt", "Regolith", "Mafic Rock", "Buddy Bud Seed", "Waterweed Seed", 
		],
		"advanced2": [
    ...
    "squelchy": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Wort Seed", "Pincha Pepper Seed", "Joya Seed", "Sporechid Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Fungal Spore", "Sleet Wheat Grain",
            "Thimble Reed Seed", "Muckroot", "Mealwood Seed", "Briar Seed", "Blossom Seed", "Ice", "Polluted Ice", "Obsidian", "Granite", "Abyssalite", "Wolframite", "Lead", "Igneous Rock", "Iron Ore",
            "Diamond", "Coal", "Slime", "Uranium Ore", "Clay", "Algae", "Gold Amalgam", "Bleach Stone", "Rust", "Salt", "Sucrose", "Sulfur", "Mafic Rock", "Copper Ore", "Regolith", "Buddy Bud Seed",
            "Hatch", "Bliss Burst Seed", "Grubfruit Seed", 
		],
		"advanced2": [
    ...
    "rime": {
		...
		"advanced": [
			"Polluted Water", "Sporechid Seed", "Abyssalite", "Lead", "Uranium Ore", "Granite", "Pincha Pepper Seed", "Saturn Critter Trap Seed", "Tranquil Toe Seed", "Thimble Reed Seed", "Fungal Spore",
            "Arbor Acorn", "Hexalent Fruit", "Waterweed Seed", "Balm Lily Seed", "Obsidian", "Fossil", "Iron Ore", "Diamond", "Polluted Ice", "Wolframite", "Phosphorite", "Sedimentary Rock", "Rust", "Sulfur",
            "Gold Amalgam", "Clay", "Bleach Stone", "Mafic Rock", "Salt", "Regolith", "Joya Seed", "Wort Seed", "Mirth Leaf Seed", "Buddy Bud Seed", "Nosh Bean", "Oxyfern Seed", 
		],
		"advanced2": [
    ...
    "verdante": {
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Bog Bucket Seed", "Mallow Seed", "Swamp Chard Heart", "Waterweed Seed", "Nosh Bean", "Dasha Saltvine Seed", "Balm Lily Seed",
            "Wort Seed", "Fungal Spore", "Buddy Bud Seed", "Obsidian", "Abyssalite", "Lead", "Granite", "Fossil", "Diamond", "Slime", "Iron Ore", "Algae", "Coal", "Mud", "Polluted Dirt", "Cobalt Ore",
            "Sedimentary Rock", "Mafic Rock", "Rust", "Polluted Mud", "Sand", "Bleach Stone", "Salt", "Fertilizer", "Gold Amalgam", "Clay", "Uranium Ore", "Ice", "Sandstone", "Wolframite", "Regolith",
            "Copper Ore", "Thimble Reed Seed",
		],
		"advanced2": [
    ...
    "arboria": {
		...
		"advanced": [
			"Polluted Water", "Wort Seed", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Bog Bucket Seed", "Mallow Seed", "Balm Lily Seed", "Waterweed Seed", "Swamp Chard Heart", "Sleet Wheat Grain",
            "Nosh Bean", "Ice", "Wolframite", "Polluted Ice", "Obsidian", "Cobalt Ore", "Abyssalite", "Iron Ore", "Diamond", "Fossil", "Lead", "Iron", "Coal", "Sand", "Sedimentary Rock", "Salt", "Bleach Stone",
            "Polluted Dirt", "Algae", "Polluted Mud", "Mud", "Uranium Ore", "Fertilizer", "Sandstone", "Mafic Rock", "Rust", "Slime", "Regolith", "Copper Ore", "Dasha Saltvine Seed", 
		],
		"advanced2": [
    ...
    "volcanea": {
		...
		"advanced": [
			"Polluted Water", "Granite", "Wort Seed", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Sleet Wheat Grain", "Waterweed Seed", "Fungal Spore",
            "Grubfruit Seed", "Bliss Burst Seed", "Buddy Bud Seed", "Ice", "Wolframite", "Obsidian", "Abyssalite", "Iron Ore", "Lead", "Diamond", "Fossil", "Phosphorite", "Polluted Ice", "Slime", "Salt",
            "Sedimentary Rock", "Clay", "Gold Amalgam", "Bleach Stone", "Sulfur", "Mafic Rock", "Uranium Ore", "Regolith", "Iron", "Thimble Reed Seed",
		],
		"advanced2": [
    ...
    "badlands": {
		...
		"advanced": [
			"Polluted Water", "Granite", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Sleet Wheat Grain", "Wort Seed", "Grubfruit Seed", "Bliss Burst Seed",
            "Nosh Bean", "Dasha Saltvine Seed", "Obsidian", "Abyssalite", "Fossil", "Lead", "Ice", "Polluted Ice", "Diamond", "Iron Ore", "Wolframite", "Iron", "Sedimentary Rock", "Phosphorite", "Bleach Stone",
            "Sulfur", "Mafic Rock", "Slime", "Uranium Ore", "Rust", "Salt", "Sucrose", "Regolith", 
		],
		"advanced2": [
    ...
    "aridio": {
		...
		"advanced": [
			"Polluted Water", "Joya Seed", "Sporechid Seed", "Pincha Pepper Seed", "Waterweed Seed", "Balm Lily Seed", "Thimble Reed Seed", "Fungal Spore", "Dasha Saltvine Seed", "Grubfruit Seed",
            "Bliss Burst Seed", "Buddy Bud Seed", "Wort Seed", "Obsidian", "Abyssalite", "Fossil", "Iron Ore", "Lead", "Granite", "Diamond", "Slime", "Coal", "Sand", "Algae", "Sedimentary Rock",
            "Bleach Stone", "Uranium Ore", "Salt", "Ice", "Wolframite", "Gold Amalgam", "Sandstone", "Clay", "Mafic Rock", "Rust", "Sulfur", "Copper Ore", "Sucrose", "Fertilizer", "Regolith", "Nosh Bean", 
		],
		"advanced2": [
    ...
    "oasisse": {
		...
		"advanced": [
			"Polluted Water", "Abyssalite", "Lead", "Uranium Ore", "Wort Seed", "Waterweed Seed", "Pincha Pepper Seed", "Sporechid Seed", "Balm Lily Seed", "Fungal Spore", "Muckroot", "Briar Seed",
            "Blossom Seed", "Grubfruit Seed", "Bliss Burst Seed", "Joya Seed", "Ice", "Wolframite", "Obsidian", "Granite", "Iron Ore", "Diamond", "Gold Amalgam", "Clay", "Slime", "Sedimentary Rock",
            "Algae", "Fossil", "Sand", "Bleach Stone", "Salt", "Coal", "Sandstone", "Copper Ore", "Mafic Rock", "Sulfur", "Fertilizer", "Iron", "Regolith", "Buddy Bud Seed", "Thimble Reed Seed",
		],
		"advanced2": [
    ...
    "terrania": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Granite", "Sporechid Seed", "Balm Lily Seed", "Fungal Spore", "Pincha Pepper Seed", "Thimble Reed Seed", "Mirth Leaf Seed", "Buddy Bud Seed",
            "Bliss Burst Seed", "Grubfruit Seed", "Wort Seed", "Obsidian", "Abyssalite", "Iron Ore", "Iron", "Gold Amalgam", "Slime", "Clay", "Phosphorite", "Bleach Stone", "Lead", "Uranium Ore",
            "Mafic Rock", "Sulfur", "Sucrose", "Polluted Ice", "Salt", "Ice", "Rust", "Wolframite", "Sleet Wheat Grain",
		],
		"advanced2": [
    ...
    "ceres_minor": {
		...
		"advanced": [
			"Polluted Water", "Hexalent Fruit", "Mirth Leaf Seed", "Mealwood Seed", "Arbor Acorn", "Grubfruit Seed", "Sporechid Seed", "Oxyfern Seed", "Bliss Burst Seed", "Pincha Pepper Seed",
            "Plume Squash Seed", "Carved Lumen Quartz", "Sleet Wheat Grain", "Wort Seed", "Waterweed Seed", "Bonbon Tree Seed", "Obsidian", "Igneous Rock", "Abyssalite", "Aluminum Ore", "Sand",
            "Sandstone", "Sulfur", "Mafic Rock", "Copper Ore", "Granite", "Coal", "Algae", "Slime", "Fossil", "Diamond", "Cobalt Ore", "Fertilizer", "Bleach Stone", "Sedimentary Rock", "Iron Ore",
            "Rust", "Sucrose", "Polluted Ice", "Wolframite", "Lead", "Uranium Ore", "Salt", "Mercury", "Nosh Bean", 
		],
		"advanced2": [
    ...
    "folia": {
		...
		"advanced": [
			"Polluted Water", "Granite", "Sleet Wheat Grain", "Grubfruit Seed", "Bliss Burst Seed", "Balm Lily Seed", "Pincha Pepper Seed", "Wort Seed", "Nosh Bean", "Dasha Saltvine Seed", "Obsidian",
            "Abyssalite", "Coal", "Iron", "Iron Ore", "Salt", "Polluted Ice", "Ice", "Sandstone", "Rust", "Sand", "Copper Ore", "Sulfur", "Sedimentary Rock", "Algae", "Sucrose", "Bleach Stone", "Lead",
            "Uranium Ore", "Wolframite", "Regolith", 
		],
		"advanced2": [
    ...
    "quagmiris": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Sporechid Seed", "Pincha Pepper Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Grubfruit Seed", "Bliss Burst Seed", "Sleet Wheat Grain", "Wort Seed",
            "Obsidian", "Abyssalite", "Iron Ore", "Algae", "Coal", "Iron", "Diamond", "Ice", "Bleach Stone", "Wolframite", "Copper Ore", "Sulfur", "Mafic Rock", "Sucrose", "Polluted Ice", "Salt", "Rust",
            "Lead", "Uranium Ore", "Granite", "Slime",
		],
		"advanced2": [
    ...
    "metallic_swampy": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Thimble Reed Seed", "Buddy Bud Seed", "Fungal Spore", "Obsidian", "Abyssalite", "Slime", "Algae", "Clay", "Gold Amalgam", "Igneous Rock", "Coal",
            "Granite", "Aluminum Ore", "Sandstone", "Polluted Ice", "Wolframite", "Ice", 
		],
		"advanced2": [
    ...
    "desolands": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Granite", "Sporechid Seed", "Joya Seed", "Pincha Pepper Seed", "Mirth Leaf Seed", "Balm Lily Seed", "Fossil", "Lead", "Abyssalite", "Iron Ore", "Slime",
            "Diamond", "Obsidian", "Iron", "Bleach Stone", 
		],
		"advanced2": [
    ...
    "frozen_forest": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Wort Seed", "Obsidian", "Abyssalite", "Rust", "Iron Ore", "Mafic Rock", "Bleach Stone", "Coal", "Algae", "Granite", "Regolith", "Dasha Saltvine Seed",
            "Pincha Pepper Seed", "Nosh Bean", 
		],
		"advanced2": [
    ...
    "flipped": {
		...
		"advanced": [
			"Polluted Water", "Sleet Wheat Grain", "Wort Seed", "Grubfruit Seed", "Bliss Burst Seed", "Sporechid Seed", "Slime", "Granite", "Ice", "Abyssalite", "Polluted Ice", "Wolframite",
            "Sedimentary Rock", "Mafic Rock", "Obsidian", 
		],
		"advanced2": [
			"Sulfur", 
		],
    ...
    "radioactive_ocean": {
		...
		"advanced": [
			"Polluted Water", "Sedimentary Rock", "Tranquil Toe Seed", "Saturn Critter Trap Seed", "Waterweed Seed", "Pincha Pepper Seed", "Obsidian", "Abyssalite", "Uranium Ore", "Rust", "Sulfur", "Ice",
            "Bleach Stone", "Wolframite", "Diamond", "Copper Ore", "Sandstone", "Fossil", "Iron Ore", "Granite", "Salt", "Sand",
		],
		"advanced2": [
    ...
    "ceres_mantle": {
		...
		"advanced": [
			"Polluted Water", "Wort Seed", "Sporechid Seed", "Carved Lumen Quartz", "Waterweed Seed", "Plume Squash Seed", "Abyssalite", "Wolframite", "Coal", "Sand", "Mafic Rock", "Iron Ore", "Rust",
            "Obsidian", "Igneous Rock", "Sedimentary Rock", "Granite", "Sucrose", "Bleach Stone", "Salt", "Sandstone", "Nosh Bean", "Pincha Pepper Seed", 
		],
		"advanced2": [
    ...
    "skewed": {
		...
		"advanced": [
			"Polluted Water", "Granite", "Sleet Wheat Grain", "Waterweed Seed", "Pincha Pepper Seed", "Wort Seed", "Balm Lily Seed", "Mirth Leaf Seed", "Sporechid Seed", "Fungal Spore", "Buddy Bud Seed",
            "Thimble Reed Seed", "Joya Seed", "Obsidian", "Abyssalite", "Fossil", "Lead", "Ice", "Polluted Ice", "Salt", "Sedimentary Rock", "Bleach Stone", "Slime", "Gold Amalgam", "Wolframite",
            "Phosphorite", "Iron Ore", "Mafic Rock", "Regolith", "Clay", "Diamond", "Iron", 
		],
		"advanced2": [
    ...
    "blasted": {
		...
		"advanced": [
			"Polluted Water", "Hexalent Fruit", "Mirth Leaf Seed", "Oxyfern Seed", "Mealwood Seed", "Joya Seed", "Sporechid Seed", "Arbor Acorn", "Pincha Pepper Seed", "Wort Seed", "Sleet Wheat Grain",
            "Saturn Critter Trap Seed", "Tranquil Toe Seed", "Plume Squash Seed", "Carved Lumen Quartz", "Waterweed Seed", "Bonbon Tree Seed", "Igneous Rock", "Obsidian", "Fossil", "Granite", "Lead",
            "Abyssalite", "Iron", "Aluminum Ore", "Iron Ore", "Coal", "Diamond", "Copper Ore", "Polluted Ice", "Gold Amalgam", "Wolframite", "Sand", "Sedimentary Rock", "Uranium Ore", "Rust", "Bleach Stone",
            "Sulfur", "Mafic Rock", "Sandstone", "Salt", "Algae", "Slime", "Sucrose", "Fertilizer", "Mercury", "Nosh Bean", 
		],
		"advanced2": [
    ...
    "relicargh": {
		...
		"advanced": [
			"Sporechid Seed", "Joya Seed", "Tranquil Toe Seed", "Seakomb Seed", "Lura Seed", "Dasha Saltvine Seed", "Wort Seed", "Dew Seed", "Waterweed Seed", "Megafrond Spore", "Obsidian", "Abyssalite",
            "Lead", "Granite", "Sand", "Diamond", "Iron Ore", "Ice", "Sulfur", "Uranium Ore", "Rust", "Bleach Stone", "Mafic Rock", "Wolframite", "Gold Amalgam", "Polluted Dirt", "Salt", "Phosphorite",
            "Sedimentary Rock", "Fossil", "Regolith", "Saturn Critter Trap Seed", "Nosh Bean", "Pincha Pepper Seed", "Coal", "Refined Carbon", "Ovagro Fig", "Polluted Ice", "Sandstone", "Solid Nuclear Waste",
            "Slime", "Cobalt", 
		],
		"advanced2": [
    ...
    "relica_minor": {
		...
		"advanced": [
			"Tranquil Toe Seed", "Saturn Critter Trap Seed", "Pincha Pepper Seed", "Sporechid Seed", "Waterweed Seed", "Seakomb Seed", "Lura Seed", "Dasha Saltvine Seed", "Megafrond Spore", "Wort Seed",
            "Dew Seed", "Obsidian", "Uranium Ore", "Bleach Stone", "Sulfur", "Ice", "Rust", "Wolframite", "Sandstone", "Granite", "Sand", "Fossil", "Diamond", "Slime", "Gold Amalgam", "Igneous Rock",
            "Polluted Dirt", "Sedimentary Rock", "Mafic Rock", "Salt", "Coal", "Iron Ore", "Phosphorite", "Regolith", "Nosh Bean", 
		],
		"advanced2": [
    ...
    "relicargh_base": {
		"basic": [
			"Water", "Polluted Water", "Peat", "Shale", "Dirt", "Nickel Ore", "Algae", "Sand", "Coal", "Snac Fruit", "Rosebush Seed", "Sweatcorn Seed", "Ovagro Fig", "Ovagro Node Seed", "Fertilizer",
            "Refined Carbon", "Mimillet", "Obsidian", "Granite", "Iron", "Igneous Rock", 
		],
		"advanced": [
    ...
    "marinea_base": {
		"basic": [
			"Water", "Polluted Water", "Starnacle Seed", "Phosphorite", "Corallium", "Coquina", "Zinc Ore", "Sand", "Sedimentary Rock", "Gum Palm Seed", "Waterweed Seed", "Flue Coral Seed", "Petta Pouf Seed", "Clampum Seed",
            "Siltstone", "Sodicane Seed", "Husha Cups Seed", "Dirt", "Salt", "Sulfur", "Mussel Tongue", "Algae", "Sandstone",
		],
		"advanced": [
			"Abyssalite", "Joya Seed", "Tublia Seed", "Sporechid Seed", "Bulbloom Seed", "Pinpoket Seed", "Pincha Pepper Seed", "Thimble Reed Seed", "Tower Kelp Seed", "Buddy Bud Seed", "Mirth Leaf Seed",
            "Arbor Acorn", "Mealwood Seed", "Dirt", "Salt",
		]
	},
    "marinea": {
		"basic": [
			"Water", "Polluted Water", "Sodicane Seed", "Waterweed Seed", "Gum Palm Seed", "Coquina", "Zinc Ore", "Corallium", "Siltstone", "Salt", "Dirt", "Sulfur", "Sand", "Mussel Tongue", "Husha Cups Seed", "Algae",
            "Phosphorite", "Clampum Seed", "Petta Pouf Seed", "Starnacle Seed", "Flue Coral Seed", "Sedimentary Rock", "Sandstone", "Wort Seed",
		],
		"advanced": [
			"Tublia Seed", "Bulbloom Seed", "Sporechid Seed", "Pinpoket Seed", "Joya Seed", "Nosh Bean", "Dasha Saltvine Seed", "Tranquil Toe Seed", "Saturn Critter Trap Seed", "Tower Kelp Seed", "Buddy Bud Seed",
            "Thimble Reed Seed", "Mallow Seed", "Mealwood Seed", "Arbor Acorn", "Oxyfern Seed", "Hexalent Fruit", "Obsidian", "Abyssalite", "Igneous Rock", "Diamond", "Fossil",
            "Basalt", "Iron Ore", "Galena", "Coal", "Lead", "Granite", "Rust", "Mafic Rock", "Uranium Ore", "Bleach Stone", "Polluted Mud", "Aluminum Ore", "Slime", "Regolith", "Copper Ore", "Pincha Pepper Seed",
		],
		"advanced2": [
			"Bog Bucket Seed", "Mallow Seed", "Polluted Dirt", "Mud", "Fertilizer", "Cobalt Ore", "Swamp Chard Heart", "Iron",
		],
		"radbolt": [
			"Grubfruit Seed", "Bliss Burst Seed", "Balm Lily Seed", "Sleet Wheat Grain", "Fungal Spore", "Sucrose", "Gold Amalgam", "Clay",
		]
	},
    "marinea_minor": {
		"basic": [
			"Water", "Polluted Water", "Waterweed Seed", "Husha Cups Seed", "Sodicane Seed", "Siltstone", "Sand", "Sulfur", "Salt", "Dirt", "Zinc Ore", "Coquina", "Algae", "Corallium", "Mussel Tongue", "Flue Coral Seed",
            "Clampum Seed", "Phosphorite", "Starnacle Seed", "Gum Palm Seed", "Sandstone", "Petta Pouf Seed", "Sedimentary Rock",
		],
		"advanced": [
			"Bulbloom Seed", "Tublia Seed", "Pinpoket Seed", "Tranquil Toe Seed", "Saturn Critter Trap Seed", "Pincha Pepper Seed", "Dasha Saltvine Seed", "Mirth Leaf Seed", "Nosh Bean", "Sporechid Seed", "Thimble Reed Seed",
            "Tower Kelp Seed", "Buddy Bud Seed", "Mealwood Seed", "Arbor Acorn", "Hexalent Fruit", "Obsidian", "Abyssalite", "Igneous Rock", "Diamond", "Fossil",
            "Basalt", "Iron Ore", "Galena", "Coal", "Lead", "Granite", "Rust", "Uranium Ore", "Bleach Stone", "Ice", "Slime", "Obsidian", "Igneous Rock", "Wolframite", "Granite", "Fertilizer", "Fossil", "Polluted Ice",
            "Mafic Rock", "Iron Ore", "Aluminum Ore", "Polluted Mud",
		],
		"advanced2": [
			"Swamp Chard Heart", "Bog Bucket Seed", "Mallow Seed", "Mud", "Cobalt Ore", "Polluted Dirt",
		],
		"radbolt": [
			"Joya Seed", "Bliss Burst Seed", "Sleet Wheat Grain", "Grubfruit Seed", "Iron", "Lead", "Polluted Ice",
		]
